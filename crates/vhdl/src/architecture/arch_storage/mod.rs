...
pub trait Arch {
    ...
    // #[salsa::interned]
    // fn intern_object_declaration(
    //     &self,
    //     obj_decl: Arc<ObjectDeclaration>,
    // ) -> Id<Arc<ObjectDeclaration>>;

    #[salsa::input]
    fn object_declaration(&self, key: Id<ObjectDeclaration>) -> ObjectDeclaration;
